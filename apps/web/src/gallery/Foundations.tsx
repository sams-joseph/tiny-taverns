...
const RAMPS = [
  ...
  {
    name: "Peach — the only colour that carries an action",
    steps: [
      { label: "700", className: "bg-peach-700" },
      { label: "600", className: "bg-peach-600" },
      { label: "500", className: "bg-peach-500" },
      { label: "400", className: "bg-peach-400" },
      { label: "300", className: "bg-peach-300" },
      { label: "200", className: "bg-peach-200" },
      { label: "100", className: "bg-peach-100" },
    ],
  },
  {
    ...
    steps: [
      ...
      { label: "300", className: "bg-crimson-300" },
  ...
  },
  {
    ...
    steps: [
      ...
      { label: "300", className: "bg-emerald-300" },
  ...
  },
  {
    ...
    steps: [
      ...
      { label: "300", className: "bg-azure-300" },
