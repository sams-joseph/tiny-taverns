...
type Rated = Extract<EncounterDifficulty, { readonly _tag: "rated" }>;
 ...
 */
function DifficultyMeter({ difficulty }: { readonly difficulty: Rated }) {
  ...
  return (
    <div aria-hidden="true" data-slot="difficulty-meter" className="relative pt-1">
      ...
      <div
        ...
        className="absolute top-0 -ml-px h-4 w-0.75 rounded-pill bg-heading ring-2 ring-surface-card"
