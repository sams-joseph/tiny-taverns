 ...
 * creature's stat block, a character's sheet and an NPC's public persona through
 * five `tsvector`s, and it applies the visibility predicate that a substring
 * match over an already-loaded list could not. So the box in the top bar asks
 * the server, and what comes back spans five sources rather than the recap
 * titles the prototype could see.
 */
 ...
 * one and `"all"` is the absence of the parameter rather than a sixth value on
