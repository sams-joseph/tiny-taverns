 ...
 * Files: 5e-SRD-Spells.json, 5e-SRD-Magic-Schools.json, 5e-SRD-Classes.json,
 * 5e-SRD-Subclasses.json, 5e-SRD-Damage-Types.json, 5e-SRD-Ability-Scores.json.
 *
 * Rebuild recipe:
 *   python - <<'PY'
...
export const SPELL_RAW = JSON.parse(String.raw`[
  {
    "index": "acid-arrow",
    "name": "Acid Arrow",
    "desc": [
...
export const MAGIC_SCHOOL_RAW = JSON.parse(String.raw`[
  {
    "index": "abjuration",
    "name": "Abjuration",
...
export const CLASS_RAW = JSON.parse(String.raw`[
  {
    "index": "barbarian",
    "name": "Barbarian",
    "hit_die": 12,
...
export const SUBCLASS_RAW = JSON.parse(String.raw`[
  {
    "index": "berserker",
    "class": {
      "index": "barbarian",
