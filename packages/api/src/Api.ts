...
import {
  ...
  NpcAwarenessCandidateApprove,
  NpcAwarenessCandidateReject,
  NpcAwarenessCandidateUpdate,
  NpcRehearsalStatus,
  NpcSessionMonitor,
  NpcSource,
  NpcRehearse,
...
/**
 * Shared Worlds: optional cross-campaign context. The wire says "world" even
 * though `Group` / `GroupId` remain the internal domain and persistence names.
 */
...
class NpcsGroup extends HttpApiGroup.make("npcs")
  .add(
    ...
    HttpApiEndpoint.get("proposals", "/:npcId/proposals", {
      params: { campaignId: CampaignId, npcId: NpcId },
      success: Schema.Array(NpcProposal),
      error: NotFound,
    }),
    HttpApiEndpoint.post("acceptProposal", "/:npcId/proposals/:proposalId/accept", {
      params: { campaignId: CampaignId, npcId: NpcId, proposalId: NpcProposalId },
      payload: Schema.Struct({}),
      success: NpcProposal,
      error: [NotFound, Conflict],
    }),
    HttpApiEndpoint.post("rejectProposal", "/:npcId/proposals/:proposalId/reject", {
      params: { campaignId: CampaignId, npcId: NpcId, proposalId: NpcProposalId },
      payload: NpcProposalReject,
      success: NpcProposal,
      error: [NotFound, Conflict],
    }),
    HttpApiEndpoint.get("awarenessCandidates", "/:npcId/awareness-candidates", {
      params: { campaignId: CampaignId, npcId: NpcId },
      success: Schema.Array(NpcAwarenessCandidate),
      error: NotFound,
    }),
    HttpApiEndpoint.patch("updateAwarenessCandidate", "/:npcId/awareness-candidates/:candidateId", {
      params: { campaignId: CampaignId, npcId: NpcId, candidateId: NpcAwarenessCandidateId },
      payload: NpcAwarenessCandidateUpdate,
      success: NpcAwarenessCandidate,
      error: [NotFound, Conflict],
    }),
    HttpApiEndpoint.post(
      "approveAwarenessCandidate",
      "/:npcId/awareness-candidates/:candidateId/approve",
      {
        params: { campaignId: CampaignId, npcId: NpcId, candidateId: NpcAwarenessCandidateId },
    ...
    HttpApiEndpoint.post(
      "rejectAwarenessCandidate",
      "/:npcId/awareness-candidates/:candidateId/reject",
      {
        params: { campaignId: CampaignId, npcId: NpcId, candidateId: NpcAwarenessCandidateId },
...
class SharedWorldHobGroup extends HttpApiGroup.make("sharedWorldHob")
  .add(
    ...
    HttpApiEndpoint.get("turns", "/threads/:threadId/turns", {
      params: { worldId: GroupId, threadId: AssistantThreadId },
      success: Schema.Array(HobTurn),
      error: NotFound,
    }),
    HttpApiEndpoint.post("accept", "/threads/:threadId/turns/:turnId/accept", {
