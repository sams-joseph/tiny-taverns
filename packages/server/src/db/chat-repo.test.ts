...
const TestLive = Layer.mergeAll(Layer.effect(ChatRepo, ChatRepo.make)).pipe(
        ...
        withTransactionRollback(
          Effect.gen(function*() {
            ...
            const messages: ReadonlyArray<typeof Chat.Message.Type> = [
              ...
              {
                role: "assistant",
                content: "It is midnight on January 1st, 2024.",
              },
            ];
            ...
            const parts = updated.messages[1]!
              .content as ReadonlyArray<Chat.MessagePart>;
